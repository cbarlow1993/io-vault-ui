...
describe('AddressValidator', () => {
  ...
  describe('EVM addresses', () => {
    const evmChain = 'ethereum' as ChainAlias;
  ...
  describe('Solana addresses', () => {
    const solanaChain = 'solana-mainnet' as ChainAlias;
  ...
  describe('Bitcoin addresses', () => {
    const bitcoinChain = 'btc-mainnet' as ChainAlias;
  ...
  describe('ValidationResult type narrowing', () => {
